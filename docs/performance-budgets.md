...
| `blocks-list-saturation` | not measured | p95 1,500 ms / p99 3,000 ms at concurrency 32, **≥20 req/s**, timeouts ≤0.1%, errors ≤1% | `generated` | target | cold | explorer | UR-1 | `bench/harness.mts --workload blocks-list-saturation` | PENDING BASELINE | Raise pool `max`, or shed load at the edge |
